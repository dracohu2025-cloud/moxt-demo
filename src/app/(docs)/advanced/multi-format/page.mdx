...
<ShowcaseEmbed src="/multi-format/heatmap.html" title="World Heatmap" description="全球 AI 采用率热力图" height="650px" />

<a href="/multi-format/heatmap.html" target="_blank" style={{display: 'inline-block', marginBottom: '32px', color: 'var(--color-primary-500)'}}>↗ 全屏查看</a>
...
<ShowcaseEmbed src="/multi-format/slide-report.html" title="Slide Report" description="翻页式汇报" height="650px" />

<a href="/multi-format/slide-report.html" target="_blank" style={{display: 'inline-block', marginBottom: '32px', color: 'var(--color-primary-500)'}}>↗ 全屏查看</a>
...
<ShowcaseEmbed src="/multi-format/dashboard.html" title="Interactive Dashboard" description="交互式数据仪表盘" height="650px" />

<a href="/multi-format/dashboard.html" target="_blank" style={{display: 'inline-block', marginBottom: '32px', color: 'var(--color-primary-500)'}}>↗ 全屏查看</a>
